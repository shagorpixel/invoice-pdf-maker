    ...
    <div class="bill-container">
        ...
        <section class="solar-usage-summary">
            ...
            <div class="graph-container">
                <h2>Monthly Solar Usage (kWh)</h2>
                <img width="100%" src="data:image/png;base64,{{ base64_encode(file_get_contents($image)) }}" alt="">
            </div>
        </section>
        ...
        <section class="charges-breakdown">
            ...
            <p style="margin-top: 10px;"><strong>Total Amount Due:</strong> ${{$invoice->Total_Amount_Due}}</p>
            <p style="margin:5px 0 ;">Last date of bill finalization <strong>{{$invoice->late_fee_end_date}}</strong></p>

            <p style="color:red;"><strong>Total Amount Due late Fee:</strong> ${{$invoice->after_late_fee_amount}} ({{$invoice->Payment_Terms}}% late Fee)</p>
        </section>
